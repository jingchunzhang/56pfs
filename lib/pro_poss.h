...
#define REQ_CONF_UPDATE 0x00000003   //更新pfs配置项请求
#define RSP_CONF_UPDATE 0x80000003   //更新PFS配置项应答
...
#define REQ_PFS_CMD 0x00000008  //PFS接受来自VOSS请求
#define RSP_PFS_CMD 0x80000008  //PFS应答给VOSS的报文

#define REQ_STOPPFS 0x00000009 //PFS接受来自VOSS的停止请求
#define RSP_STOPPFS 0x80000009
...
int create_poss_head(char *outbuf, unsigned int cmdid, int datalen);
#endif
