...
enum {OPER_IDLE, OPER_GET_REQ, OPER_GET_RSP, OPER_SYNC_2_DOMAIN, OPER_PUT_REQ, OPER_PUT_RSP, OPER_UP_REQ, OPER_FROM_POSS};  
...
enum {OVER_UNKNOWN = 0, OVER_OK, OVER_E_MD5, OVER_PEERERR, TASK_EXIST, OVER_PEERCLOSE, OVER_UNLINK, OVER_TIMEOUT, OVER_MALLOC, OVER_SRC_DOMAIN_ERR, OVER_SRC_IP_OFFLINE, OVER_E_OPEN_SRCFILE, OVER_E_OPEN_DSTFILE, OVER_E_IP, OVER_E_TYPE, OVER_SEND_LEN, OVER_TOO_MANY_TRY, OVER_DISK_ERR, OVER_UP_ERR, OVER_LAST};  /*任务结束时的状态*/
